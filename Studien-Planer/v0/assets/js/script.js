...
let wi = new Studiengang("Wirtschafts-Informatik", "INF");
let mi1 = new Studiengang("Medizinische-Informatik", "MIPB");
let mi2 = new Studiengang("Medizinische-Informatik", "MIPB");

let infSemPlan = new Semesterplan("Mein Plan", "WiSe 2023", pi.id);
let wiSemPlan = new Semesterplan("Mein Plan2", "SS 2022", wi.id);
let miSemPlan = new Semesterplan("Mein Plan3", "WiSe 2023", mi1.id);
let mi2SemPlan = new Semesterplan("Mein Plan4", "WiSe 2023", mi2.id);
